...
<div id="main-content" class="main-content">
    <div id="home-main-content" class="home-main-content home-1">
        <div id="rev_slider_4_1_wrapper" class="rev_slider_wrapper fullwidthbanner-container"
            data-alias="home-1" data-source="gallery"
            style="padding:0px;background-image:url({{asset('frontend')}}/'images/slides/h1-slider1.jpg');background-repeat:no-repeat;background-size:cover;background-position:center center;">
            ...
            <div id="rev_slider_4_1" class="rev_slider fullwidthabanner" style="display:none;"
                ...
                <ul>
                    <li data-index="rs-10" data-transition="fade" data-slotamount="default"
                        ...
                        data-thumb="{{asset('frontend')}}/images/slides/h1-slider1-100x50.jpg" data-rotate="0"
                        data-saveperformance="off" data-title="Slide" data-param1 data-param2 data-param3
                        data-param4 data-param5 data-param6 data-param7 data-param8 data-param9 data-param10
                        data-description>

                        <img data-cfsrc="{{asset('frontend')}}/images/slides/h1-slider1.jpg" alt title="hotel-wp-demo3-slider.jpg"
                            width="1422" height="800" data-bgposition="center center" data-bgfit="cover"
                            data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina
                            style="display:none;visibility:hidden;"><noscript><img
                                src="{{asset('frontend')}}/images/slides/h1-slider1.jpg" alt title="hotel-wp-demo3-slider.jpg"
                                width="1422" height="800" data-bgposition="center center" data-bgfit="cover"
                                data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina></noscript>


                        <h1 class="tp-caption   tp-resizeme" id="slide-10-layer-1"
                            data-x="['center','center','center','center']" data-hoffset="['8','8','8','7']"
                            data-y="['middle','middle','middle','middle']"
                            data-voffset="['-109','-109','-109','-62']" data-fontsize="['66','66','40','30']"
                            data-lineheight="['78','78','50','36']" data-fontweight="['700','700','700','700']"
                        ...
                        <div class="tp-caption   tp-resizeme  thim-link-slider2" id="slide-10-layer-3"
                            ...
                            data-y="['middle','middle','middle','middle']"
                            data-voffset="['105','105','89','114']" data-lineheight="['1','1','','']"
                            data-width="none" data-height="none" data-whitespace="nowrap" data-type="text"
                    ...
                    <li data-index="rs-11" data-transition="fade" data-slotamount="default"
                        data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default"
                        data-easeout="default" data-masterspeed="300"
                        data-thumb="{{asset('frontend')}}/images/slides/h1-slider2-100x50.jpg" data-rotate="0"
                        data-saveperformance="off" data-title="Slide" data-param1 data-param2 data-param3
                        data-param4 data-param5 data-param6 data-param7 data-param8 data-param9 data-param10
                        data-description>

                        <img data-cfsrc="{{asset('frontend')}}/images/slides/h1-slider2.jpg" alt title="hotel-wp-slider-2"
                            width="1461" height="800" data-bgposition="center center" data-bgfit="cover"
                            data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina
                            style="display:none;visibility:hidden;"><noscript><img
                                src="{{asset('frontend')}}/images/slides/h1-slider2.jpg" alt title="hotel-wp-slider-2" width="1461"
                                height="800" data-bgposition="center center" data-bgfit="cover"
                                data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina></noscript>
                        ...
                        <h1 class="tp-caption   tp-resizeme" id="slide-11-layer-1"
                            ...
                            data-y="['middle','middle','middle','middle']"
                            data-voffset="['-60','-60','-75','-48']" data-fontsize="['64','64','40','30']"
                            data-lineheight="['','','50','36']" data-width="none" data-height="none"
                        ...
                        <div class="tp-caption   tp-resizeme  thim-link-slider2" id="slide-11-layer-3"
                            ...
                            data-y="['middle','middle','middle','middle']"
                            data-voffset="['105','105','88','108']" data-width="none" data-height="none"
                    ...
                    <li data-index="rs-12" data-transition="fade" data-slotamount="default"
                        data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default"
                        data-easeout="default" data-masterspeed="300"
                        data-thumb="images/slides/h1-slider3-100x50.jpg" data-rotate="0"
                        data-saveperformance="off" data-title="Slide" data-param1 data-param2 data-param3
                        data-param4 data-param5 data-param6 data-param7 data-param8 data-param9 data-param10
                        data-description>

                        <img data-cfsrc="{{asset('frontend')}}/images/slides/h1-slider3.jpg" alt title="hotel-wp-slider-3"
                            width="1461" height="800" data-bgposition="center center" data-bgfit="cover"
                            data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina
                            style="display:none;visibility:hidden;"><noscript><img
                                src="{{asset('frontend')}}/images/slides/h1-slider3.jpg" alt title="hotel-wp-slider-3" width="1461"
                                height="800" data-bgposition="center center" data-bgfit="cover"
                                data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina></noscript>
                        ...
                        <h1 class="tp-caption   tp-resizeme" id="slide-12-layer-1"
                            ...
                            data-y="['middle','middle','middle','middle']"
                            data-voffset="['-60','-60','-80','-60']" data-fontsize="['64','64','40','30']"
                            data-lineheight="['','','50','36']" data-width="none" data-height="none"
                            data-whitespace="nowrap" data-type="text" data-responsive_offset="on"
                            data-frames="[{&quot;delay&quot;:300,&quot;speed&quot;:1500,&quot;frame&quot;:&quot;0&quot;,&quot;from&quot;:&quot;x:{-250,250};y:{-150,150};rX:{-90,90};rY:{-90,90};rZ:{-360,360};sX:0;sY:0;opacity:0;&quot;,&quot;to&quot;:&quot;o:1;&quot;,&quot;ease&quot;:&quot;Power3.easeInOut&quot;},{&quot;delay&quot;:&quot;wait&quot;,&quot;speed&quot;:100,&quot;frame&quot;:&quot;999&quot;,&quot;to&quot;:&quot;opacity:0;&quot;,&quot;ease&quot;:&quot;Power2.easeIn&quot;}]"
                            data-textAlign="['center','center','center','center']" data-paddingtop="[0,0,0,0]"
                        ...
                        <div class="tp-caption   tp-resizeme  thim-link-slider2" id="slide-12-layer-3"
                            data-x="['center','center','center','center']" data-hoffset="['3','3','0','1']"
                            data-y="['middle','middle','middle','middle']"
                            data-voffset="['105','105','68','97']" data-width="none" data-height="none"
                            data-whitespace="nowrap" data-type="text"
                            data-actions="[{&quot;event&quot;:&quot;click&quot;,&quot;action&quot;:&quot;simplelink&quot;,&quot;target&quot;:&quot;_blank&quot;,&quot;url&quot;:&quot;rooms.html&quot;,&quot;delay&quot;:&quot;&quot;}]"
                            data-responsive_offset="on"
                            data-frames="[{&quot;delay&quot;:900,&quot;speed&quot;:1500,&quot;frame&quot;:&quot;0&quot;,&quot;from&quot;:&quot;y:bottom;rX:-20deg;rY:-20deg;rZ:0deg;&quot;,&quot;to&quot;:&quot;o:1;&quot;,&quot;ease&quot;:&quot;Power3.easeOut&quot;},{&quot;delay&quot;:&quot;wait&quot;,&quot;speed&quot;:100,&quot;frame&quot;:&quot;999&quot;,&quot;to&quot;:&quot;opacity:0;&quot;,&quot;ease&quot;:&quot;nothing&quot;}]"
                ...
                <div class="hotel-booking-search style-01">
                    <form action="https://html.thimpress.com/hotelwp/rooms-search.html" class="hb-search-form">
                        <ul class="hb-form-table">
                            <li><input type="text" id="multidate" class="multidate" value data-date-min="6" />
                            </li>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="sc-img-box row">
                            <div class="col-sm-6">
                                <a href="gallery-full-width.html"><img data-cfsrc="{{asset('frontend')}}/images/home/h1-img1.jpg" alt
                                        style="display:none;visibility:hidden;"><noscript><img
                                            src="{{asset('frontend')}}/images/home/h1-img1.jpg" alt></noscript></a>
                            </div>
                            <div class="col-sm-6">
                                <a href="gallery-full-width.html"><img data-cfsrc="{{asset('frontend')}}/images/home/h1-img2.jpg" alt
                                        style="display:none;visibility:hidden;"><noscript><img
                                            src="{{asset('frontend')}}/images/home/h1-img2.jpg" alt></noscript></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="sc-posts style-01 auto-height">
                        <div class="item row">
                            <div class="post col-sm-6 col-md-4">
                                <div class="inner">
                                    <div class="thumbnail">
                                        <a href="blog-single.html"><img data-cfsrc="{{asset('frontend')}}/images/gallery/img-10.jpg"
                                                alt style="display:none;visibility:hidden;"><noscript><img
                                                    src="{{asset('frontend')}}/images/gallery/img-10.jpg" alt></noscript></a>
                                    </div>
                                    <div class="content">
                            ...
                            <div class="post col-sm-6 col-md-4">
                                <div class="inner">
                                    <div class="thumbnail">
                                        <a href="blog-single.html"><img data-cfsrc="{{asset('frontend')}}/images/gallery/img-1.jpg"
                                                alt style="display:none;visibility:hidden;"><noscript><img
                                                    src="{{asset('frontend')}}/images/gallery/img-1.jpg" alt></noscript></a>
                                    </div>
                                    <div class="content">
                            ...
                            <div class="post col-sm-6 col-md-4">
                                <div class="inner">
                                    <div class="thumbnail">
                                        <a href="blog-single.html"><img data-cfsrc="{{asset('frontend')}}/images/gallery/img-3.jpg"
                                                alt style="display:none;visibility:hidden;"><noscript><img
                                                    src="{{asset('frontend')}}/images/gallery/img-3.jpg" alt></noscript></a>
                                    </div>
                                    <div class="content">
                            ...
                            <div class="post col-sm-6 col-md-4">
                                <div class="inner">
                                    <div class="thumbnail">
                                        <a href="blog-single.html"><img data-cfsrc="{{asset('frontend')}}/images/gallery/img-7.jpg"
                                                alt style="display:none;visibility:hidden;"><noscript><img
                                                    src="{{asset('frontend')}}/images/gallery/img-7.jpg" alt></noscript></a>
                                    </div>
                                    <div class="content">
                            ...
                            <div class="post col-sm-6 col-md-4">
                                <div class="inner">
                                    <div class="thumbnail">
                                        <a href="blog-single.html"><img data-cfsrc="{{asset('frontend')}}/images/gallery/img-8.jpg"
                                                alt style="display:none;visibility:hidden;"><noscript><img
                                                    src="{{asset('frontend')}}/images/gallery/img-8.jpg" alt></noscript></a>
                                    </div>
                                    <div class="content">
                            ...
                            <div class="post col-sm-6 col-md-4">
                                <div class="inner">
                                    <div class="thumbnail">
                                        <a href="blog-single.html"><img data-cfsrc="images/gallery/img-11.jpg"
                                                alt style="display:none;visibility:hidden;"><noscript><img
                                                    src="images/gallery/img-11.jpg" alt></noscript></a>
                                    </div>
                                    <div class="content">
                                        <h3 class="title"> <a href="blog-single.html">Outdoor</a></h3>
                                        <div class="short-text"> 2 Day 3 night, Start from $500</div>
                            ...
                            <div class="row">
                                <div class="room col-sm-4 clearfix">
                                    <div class="room-item">
                                        <div class="room-media">
                                            <a href="room-single.html"><img
                                                    data-cfsrc="{{asset('frontend')}}/images/gallery/img-4.jpg" alt
                                                    style="display:none;visibility:hidden;"><noscript><img
                                                        src="{{asset('frontend')}}/images/gallery/img-4.jpg" alt></noscript></a>
                                        </div>
                                ...
                                <div class="room col-sm-4 clearfix">
                                    <div class="room-item">
                                        <div class="room-media">
                                            <a href="room-single.html"><img
                                                    data-cfsrc="{{asset('frontend')}}/images/gallery/img-11.jpg" alt
                                                    style="display:none;visibility:hidden;"><noscript><img
                                                        src="{{asset('frontend')}}/images/gallery/img-11.jpg" alt></noscript></a>
                                        </div>
                                        <div class="room-summary">
                                            <h3 class="room-title">
                                ...
                                <div class="room col-sm-4 clearfix">
                                    <div class="room-item">
                                        <div class="room-media">
                                            <a href="room-single.html"><img
                                                    data-cfsrc="{{asset('frontend')}}/images/gallery/img-6.jpg" alt
                                                    style="display:none;visibility:hidden;"><noscript><img
                                                        src="{{asset('frontend')}}/images/gallery/img-6.jpg" alt></noscript></a>
                                        </div>
                                        <div class="room-summary">
                                            <h3 class="room-title">
                    ...
                    <div class="sc-testimonials style-01">
                        ...
                        <div class="testimonial-slider" data-itemsvisible="3" data-nav="false">
                            <div class="item">
                                <div class="content">
                                    <div class="image">
                                        <img data-cfsrc="{{asset('frontend')}}/images/blog/sidebar.jpg" alt
                                            style="display:none;visibility:hidden;"><noscript><img
                                                src="{{asset('frontend')}}/images/blog/sidebar.jpg" alt></noscript>
                                    </div>
                            ...
                            <div class="item">
                                <div class="content">
                                    <div class="image">
                                        <img data-cfsrc="{{asset('frontend')}}/images/blog/author1.jpg" alt
                                            style="display:none;visibility:hidden;"><noscript><img
                                                src="{{asset('frontend')}}/images/blog/author1.jpg" alt></noscript>
                                    </div>
                                    <div class="rating-star"></div>
                                    <div class="description">
                                        " Conversations can be a tricky business. Sometimes, decoding what is
                            ...
                            <div class="item">
                                <div class="content">
                                    <div class="image">
                                        <img data-cfsrc="{{asset('frontend')}}/images/blog/author2.jpg" alt
                                            style="display:none;visibility:hidden;"><noscript><img
                                                src="{{asset('frontend')}}/images/blog/author2.jpg" alt></noscript>
                                    </div>
                                    <div class="rating-star"></div>
                                    <div class="description">
                                        " Conversations can be a tricky business. Sometimes, decoding what is
                ...
                <div class="container">
                                ...
                                <div class="post col-sm-12 col-md-12">
                                    <div class="inner">
                                        ...
                                        <div class="content">
                                            ...
                                            <h3 class="title"> <a href="blog-single.html"> Futurethon – Explore
                                                    the future</a></h3>
                                            <div class="date"><i class="ion-android-calendar"></i>15 July, 2018
                                            </div>
                                            <div class="summary">We continuously strive to enhance our living
                                                and working environments. The environments we live in today are
                                                almost unrecognisable from those that existed.</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="item col-sm-12 col-md-6">
                                <div class="post col-sm-6 col-md-6">
                                    <div class="inner">
                                        <div class="thumbnail">
                                            <a href="blog-single.html"><img
                                                    data-cfsrc="{{asset('frontend')}}/images/gallery/img-5.jpg" alt
                                                    style="display:none;visibility:hidden;"><noscript><img
                                                        src="{{asset('frontend')}}/images/gallery/img-5.jpg" alt></noscript></a>
                                        </div>
                                        <div class="content">
                                ...
                                <div class="post col-sm-6 col-md-6">
                                    <div class="inner">
                                        <div class="thumbnail">
                                            <a href="blog-single.html"><img
                                                    data-cfsrc="images/gallery/img-7.jpg" alt
                                                    style="display:none;visibility:hidden;"><noscript><img
                                                        src="images/gallery/img-7.jpg" alt></noscript></a>
                                        </div>
                                        <div class="content">
                                ...
                                <div class="post col-sm-6 col-md-6">
                                    <div class="inner">
                                        <div class="thumbnail">
                                            <a href="blog-single.html"><img
                                                    data-cfsrc="images/gallery/img-9.jpg" alt
                                                    style="display:none;visibility:hidden;"><noscript><img
                                                        src="images/gallery/img-9.jpg" alt></noscript></a>
                                        </div>
                                        <div class="content">
                                            <div class="category"><a href="#">Hotel</a></div>
                                            <h3 class="title"> <a href="blog-single.html">Outdoor</a></h3>
                    ...
                    <div class="sc-gallery style-01">
                        <div class="gallery-slider owl-carousel owl-theme">
                            <div class="item">
                                <div class="gallery">
                                    <a href="#gallery-1" class="btn-gallery"><img
                                            data-cfsrc="images/gallery/img-6.jpg" alt
                                            style="display:none;visibility:hidden;"><noscript><img
                                                src="images/gallery/img-6.jpg" alt></noscript></a>
                                    <div id="gallery-1" class="hidden">
                                        <a href="images/gallery/img-10.jpg"><img
                                                data-cfsrc="images/gallery/img-10.jpg" alt
                                                style="display:none;visibility:hidden;"><noscript><img
                                                    src="images/gallery/img-10.jpg" alt></noscript></a>
                                        <a href="images/gallery/img-6.jpg"><img
                                                data-cfsrc="images/gallery/img-6.jpg" alt
                                                style="display:none;visibility:hidden;"><noscript><img
                                                    src="images/gallery/img-6.jpg" alt></noscript></a>
                                        <a href="images/gallery/img-11.jpg"><img
                                                data-cfsrc="images/gallery/img-11.jpg" alt
                                                style="display:none;visibility:hidden;"><noscript><img
                                                    src="images/gallery/img-11.jpg" alt></noscript></a>
                                    </div>
                                </div>
                            ...
                            <div class="item">
                                <div class="gallery">
                                    <div class="gallery">
                                        <a href="#gallery-2" class="btn-gallery"><img
                                                data-cfsrc="images/gallery/img-7.jpg" alt
                                                style="display:none;visibility:hidden;"><noscript><img
                                                    src="images/gallery/img-7.jpg" alt></noscript></a>
                                        <div id="gallery-2" class="hidden">
                                            <a href="images/gallery/img-2.jpg"><img
                                                    data-cfsrc="images/gallery/img-2.jpg" alt
                                                    style="display:none;visibility:hidden;"><noscript><img
                                                        src="images/gallery/img-2.jpg" alt></noscript></a>
                                            <a href="images/gallery/img-7.jpg"><img
                                                    data-cfsrc="images/gallery/img-7.jpg" alt
                                                    style="display:none;visibility:hidden;"><noscript><img
                                                        src="images/gallery/img-7.jpg" alt></noscript></a>
                                            <a href="images/gallery/img-8.jpg"><img
                                                    data-cfsrc="images/gallery/img-8.jpg" alt
                                                    style="display:none;visibility:hidden;"><noscript><img
                                                        src="images/gallery/img-8.jpg" alt></noscript></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="content">
                            ...
                            <div class="item">
                                <div class="gallery">
                                    <a href="#gallery-3" class="btn-gallery"><img
                                            data-cfsrc="images/gallery/img-9.jpg" alt
                                            style="display:none;visibility:hidden;"><noscript><img
                                                src="images/gallery/img-9.jpg" alt></noscript></a>
                                    <div id="gallery-3" class="hidden">
                                        <a href="images/gallery/img-12.jpg"><img
                                                data-cfsrc="images/gallery/img-12.jpg" alt
                                                style="display:none;visibility:hidden;"><noscript><img
                                                    src="images/gallery/img-12.jpg" alt></noscript></a>
                                        <a href="images/gallery/img-1.jpg"><img
                                                data-cfsrc="images/gallery/img-1.jpg" alt
                                                style="display:none;visibility:hidden;"><noscript><img
                                                    src="images/gallery/img-1.jpg" alt></noscript></a>
                                        <a href="images/gallery/img-9.jpg"><img
                                                data-cfsrc="images/gallery/img-9.jpg" alt
                                                style="display:none;visibility:hidden;"><noscript><img
                                                    src="images/gallery/img-9.jpg" alt></noscript></a>
                                    </div>
                            ...
                            <div class="item">
                                <div class="gallery">
                                    <a href="#gallery-4" class="btn-gallery"><img
                                            data-cfsrc="images/gallery/img-13.jpg" alt
                                            style="display:none;visibility:hidden;"><noscript><img
                                                src="images/gallery/img-13.jpg" alt></noscript></a>
                                    <div id="gallery-4" class="hidden">
                                        <a href="images/gallery/img-14.jpg"><img
                                                data-cfsrc="images/gallery/img-14.jpg" alt
                                                style="display:none;visibility:hidden;"><noscript><img
                                                    src="images/gallery/img-14.jpg" alt></noscript></a>
                                        <a href="images/gallery/img-7.jpg"><img
                                                data-cfsrc="images/gallery/img-7.jpg" alt
                                                style="display:none;visibility:hidden;"><noscript><img
                                                    src="images/gallery/img-7.jpg" alt></noscript></a>
                                        <a href="images/gallery/img-13.jpg"><img
                                                data-cfsrc="images/gallery/img-13.jpg" alt
                                                style="display:none;visibility:hidden;"><noscript><img
                                                    src="images/gallery/img-13.jpg" alt></noscript></a>
                                    </div>
                            ...
                            <div class="item">
                                <div class="gallery">
                                    <a href="#gallery-5" class="btn-gallery"><img
                                            data-cfsrc="images/gallery/img-1.jpg" alt
                                            style="display:none;visibility:hidden;"><noscript><img
                                                src="images/gallery/img-1.jpg" alt></noscript></a>
                            ...
                            <div class="item">
                                <div class="gallery">
                                    <a href="#gallery-7" class="btn-gallery"><img
                                            data-cfsrc="images/gallery/img-3.jpg" alt
                                            style="display:none;visibility:hidden;"><noscript><img
                                                src="images/gallery/img-3.jpg" alt></noscript></a>
                                    <div id="gallery-6" class="hidden">
                                        <a href="images/gallery/img-4.jpg"><img
                                                data-cfsrc="images/gallery/img-4.jpg" alt
                                                style="display:none;visibility:hidden;"><noscript><img
                                                    src="images/gallery/img-4.jpg" alt></noscript></a>
                                        <a href="images/gallery/img-7.jpg"><img
                                                data-cfsrc="images/gallery/img-7.jpg" alt
                                                style="display:none;visibility:hidden;"><noscript><img
                                                    src="images/gallery/img-7.jpg" alt></noscript></a>
                                        <a href="images/gallery/img-3.jpg"><img
                                                data-cfsrc="images/gallery/img-3.jpg" alt
                                                style="display:none;visibility:hidden;"><noscript><img
                                                    src="images/gallery/img-3.jpg" alt></noscript></a>
                                    </div>
